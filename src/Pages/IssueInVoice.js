...
const Register = () => {
    ...
    const [amountloading, setamountloading] = useState("");
    ...
    const RelationshipArray = ["Mother", "Father", "Friend", "Aunty", "Uncle", "Niece", "Nephew", "Sister", "Brother", "Grand Mother", "Grand Father", "Other"];
    ...
    const [clientproductListUpdate, setclientproductListUpdate] = useState(false);
    ...
    const steps = ["Customer Data", "Deceased Data", "Select Particular Bed", "Product Selection", "Payment Amount", "Invoice Receipt", "Interment Cert"];
                                    ...
                                    <div className=" mx-28 py-12">
                                        <div className=" grid place-items-center">
                                            <div style={{ border: "2px solid #000000", padding: 8 }} className=" space-y-2 pb-3 ">
                                                <h1 className=" font-semibold">{`VALUE ADDED TAX : ₵ ${resultSALE_OF_GARVE.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}</h1>
                                                <h1 className=" font-semibold">{`NHIL & GET FUND LEVY : ₵ ${Total_Combination_of_Tax1.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}</h1>
                                ...
                                activeStep === 6 && (
                                    <>
                                        ...
                                        <div className="py-3">
                                            <Button onClick={() => {
                                                navigate("/all-deceased");
                                            }} variant="contained" style={{ backgroundColor: "#083050", color: "white", paddingLeft: 13, paddingRight: 13 }}>Done</Button>
                                        </div>
                                    </>
                                )
                            }
