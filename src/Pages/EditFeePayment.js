        ...
        <>
            ...
            <div className=' grid grid-cols-9'>
                ...
                <div className=' col-span-7 bg-[#D2D2CF]'>
                    ...
                    <div className="mx-8">
                        <div>
                            <h1 className=" text-4xl font-bold  text-[#111927] py-3 pt-5">
                               Edit Fee and Tax Setting
                            </h1>
                        </div>
                                ...
                                get_all_tax.map((list) => {
                                    return (
                                        <div className=' bg-white text-center'>
                                            ...
                                            <div className=' py-2'>
                                                {`GHS ${list.vat.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                                            </div>
                                        </div>
                                    );
                                })
                                ...
                                get_all_tax.map((list) => {
                                    return (
                                        <div className=' bg-white text-center'>
                                            ...
                                            <div className=' py-2'>
                                                {`GHS ${list.nhil_levy.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                                            </div>
                                        </div>
                                    );
                                })
                        ...
                        <div className=' grid grid-cols-3 pt-8 gap-10'>
                            ...
                            <div style={{ border: "1px solid #dddddd" }} className=' shadow-md p-4 rounded-[10px] bg-[white] '>
                                ...
                                <div className=' space-y-6 px-4 py-4'>
                                    <FormControl fullWidth>
                                        <InputLabel label="Amount" id="demo-simple-select-label">Select Product</InputLabel>
                                        <Select
                                            value={productselect}
