...
const EditBed = () => {
    ...
    const Edit_Bed = () => {
        ...
        axios.put(`${BASEURL}/beds/${bedNameId}`, payload).then((response) => {
            const data = response.data;
            setloading(false);
            if (data) {
    ...
    const EditField = () => {
        ...
        axios.put(`${BASEURL}/fields/${bedNameId}`, payload).then((response) => {
            const data = response.data;
    ...
    const Edit_Number = () => {
        ...
        const payload = {
            name: alphabeteditValue
        }

        axios.put(`${BASEURL}/letters/${alphabt}`, payload).then((response) => {
            const data = response.data;
    ...
    const EditNumberValue = () => {
        ...
        const payload = {
            number: neweditnumVlaue
        }

        axios.put(`${BASEURL}/numbers/${editnum}`, payload).then((response) => {
            const data = response.data;
                ...
                <div className=' col-span-7 bg-[#D2D2CF]'>
                    ...
                    <div className='  mx-2 lg:mx-8 mt-3'>
                        ...
                        <div className=' grid grid-cols-3 gap-4 bg-[white] py-5 mt-2  px-4 rounded-[4px] shadow-lg'>
                            ...
                            <div>
                                <TextField label="Value" fullWidth placeholder='Value' value={value} onChange={(e) => {
                            ...
                            <div className=' flex justify-end'>
                                {loading ? <Button style={{ backgroundColor: "#083050", color: "white", width: "40%", paddingTop: 15, paddingBottom: 15, marginLeft: 10, marginRight: 10 }}><CircularProgress size={17} style={{ color: "white" }} /></Button> :
                                    <Button disabled={!value} onClick={Edit_Bed} style={{ backgroundColor: "#083050", color: "white", width: "40%", paddingTop: 15, paddingBottom: 15, marginLeft: 10, marginRight: 10 }}>Submit</Button>
                                }
                            </div>
                        </div>

                        <h1 className=" text-xl lg:text-xl font-bold  text-[#111927] py-2 pt-2 mt-5">
                            Select to Edit Section
                        </h1>
                        <div className=' grid grid-cols-4 gap-4 bg-[white] py-5 mt-2  px-4 rounded-[4px] shadow-lg'>
                            ...
                            <div>
                                <TextField label="Value" fullWidth value={editField} onChange={(e) => {
                            ...
                            <div className=' flex justify-end'>
                                {editloading ? <Button style={{ backgroundColor: "#083050", color: "white", width: "45%", paddingTop: 15, paddingBottom: 15, marginLeft: 10, marginRight: 10 }}><CircularProgress size={17} style={{ color: "white" }} /></Button> :
                                    <Button onClick={EditField} style={{ backgroundColor: "#083050", color: "white", width: "45%", paddingTop: 15, paddingBottom: 15, marginLeft: 10, marginRight: 10 }}>Submit</Button>}
                        ...
                        <div className=' grid grid-cols-5 gap-4 bg-[white] py-5 mt-2  px-4 rounded-[4px] shadow-lg'>
                            ...
                            <div>
                                <TextField value={alphabeteditValue} onChange={(e) => {
                                    setalphabeteditValue(e.target.value);
                                }} fullWidth label="Value" placeholder='value' />
                            </div>
                            <div className=' flex justify-end'>
                                {numberloading ? <Button style={{ backgroundColor: "#083050", color: "white", width: "45%", paddingTop: 15, paddingBottom: 15, marginLeft: 10, marginRight: 10 }}><CircularProgress size={17} style={{ color: "white" }} /></Button> :
                                    <Button disabled={!alphabeteditValue} onClick={Edit_Number} style={{ backgroundColor: "#083050", color: "white", width: "45%", paddingTop: 15, paddingBottom: 15, marginLeft: 10, marginRight: 10 }}>Submit</Button>}
                        ...
                        <h1 className=" text-xl lg:text-xl font-bold  text-[#111927] py-2 pt-2 mt-5">
                            Select to Edit division
                        </h1>
                        <div className=' grid grid-cols-6 gap-4 bg-[white] py-5 mt-2  px-4 rounded-[4px] shadow-lg'>
                            <div>
                                <FormControl fullWidth>
                                    <InputLabel id="demo-simple-select-label">Select Bed</InputLabel>
                                    <Select
                            ...
                            <div>
                                <TextField type="number" value={neweditnumVlaue} onChange={(e) => {
                                    setneweditnumVlaue(e.target.value);
                                }} fullWidth label="Value" placeholder='value' />
                            </div>
                            <div className=' flex justify-end'>
                                {lasteditnumloading ? <Button style={{ backgroundColor: "#083050", color: "white", width: "45%", paddingTop: 15, paddingBottom: 15, marginLeft: 10, marginRight: 10 }}><CircularProgress size={17} style={{ color: "white" }} /></Button> :
                                    <Button disabled={!neweditnumVlaue} onClick={EditNumberValue} style={{ backgroundColor: "#083050", color: "white", width: "45%", paddingTop: 15, paddingBottom: 15, marginLeft: 10, marginRight: 10 }}>Submit</Button>}
